...
function AddEmoteMenu(menu)
    local submenu = _menuPool:AddSubMenu(menu, "Animations", "", "", Menuthing, Menuthing)
    local dancemenu = _menuPool:AddSubMenu(submenu, "🕺 Dance Animations", "", "", Menuthing, Menuthing)
    local propmenu = _menuPool:AddSubMenu(submenu, "📦 Prop Animations", "", "", Menuthing, Menuthing)
...
function AddCancelEmote(menu)
    local newitem = NativeUI.CreateItem("Stop Emote ", "~r~X~w~ Stops the emote")
...
function AddWalkMenu(menu)
    local submenu = _menuPool:AddSubMenu(menu, "Loopstyling", "", "", Menuthing, Menuthing)
...
function AddFaceMenu(menu)
    ...
    facereset = NativeUI.CreateItem("Normaal (Reset)", "Reset to default")
...
AddEventHandler('animations:client:ToggleMenu', function()
  if CanDoEmote then
    ...
    QBCore.Functions.Notify("You can't do emotes right now", "error")
  end
end)

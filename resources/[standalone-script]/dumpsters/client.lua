...
local dumpsters = {218085040, 666561306, -58485588, -206690185, 1511880420, 682791951, 1329570871, 1437508529, 811169045, -14708062}
    ...
    while true do
        ...
        if canSearch then
            ...
            for i = 1, #dumpsters do
                ...
                if dist < 1.8 then
                    DrawText3Ds(dumpPos.x, dumpPos.y, dumpPos.z + 1.0, 'Press [~g~E~w~] To search the waste bin')
                    if IsControlJustReleased(0, 54) then
                        for i = 1, #searched do
                            ...
                            elseif i == #searched and not dumpsterFound then
                                ...
                                TriggerServerEvent('QBCore:startdumpsterTimer', dumpster)
...
RegisterNetEvent('QBCore:removedumpster')
AddEventHandler('QBCore:removedumpster', function(object)
    for i = 1, #searched do

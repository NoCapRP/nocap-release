    ...
    methods: {
        changePage(page) {
            ...
            if (page == "Home") {
                ...
                $.post('http://ARS-Mdt/getWarrants', JSON.stringify({}));
        ...
        closeMDT() {
            $.post('http://ARS-Mdt/close', JSON.stringify({}));
        },
        OffenderSearch() {
            if (this.offender_search) {

                this.offender_results.query = this.offender_search;
                $.post('http://ARS-Mdt/performOffenderSearch', JSON.stringify({
        ...
        ForensicsSearch() {
            if (this.offender_search) {
                ...
                this.offender_results.query = this.offender_search;
                $.post('http://ARS-Mdt/performForensicsSearch', JSON.stringify({
                    query: this.offender_search
                }));
        ...
        OpenOffenderDetails(id) {
            for (var key in this.offender_results.results) {
                if (id == this.offender_results.results[key].citizenid) {
                    ...
                    $.post('http://ARS-Mdt/viewOffender', JSON.stringify({
        ...
        SaveOffenderChanges() {
            $.post('http://ARS-Mdt/saveOffenderChanges', JSON.stringify({
        ...
        ReportSearch() {
            if (this.report_search) {
                ...
                $.post('http://ARS-Mdt/performReportSearch', JSON.stringify({
        ...
        SubmitNewReport() {
            if (this.report_new.title && this.report_new.char_id && (Object.keys(this.report_new.charges).length > 0) && this.report_new.incident) {
                $.post('http://ARS-Mdt/submitNewReport', JSON.stringify({
        ...
        OpenOffenderDetailsById(id) {
            $.post('http://ARS-Mdt/getOffender', JSON.stringify({
                char_id: id
            }));
        ...
        DeleteSelectedReport() {
            $.post('http://ARS-Mdt/deleteReport', JSON.stringify({
        ...
        SaveReportEditChanges() {
            $.post('http://ARS-Mdt/saveReportChanges', JSON.stringify({
                id: this.report_selected.id,
        ...
        VehicleSearch() {
            if (this.vehicle_search) {
                ...
                $.post('http://ARS-Mdt/vehicleSearch', JSON.stringify({
        ...
        OpenVehicleDetails(result) {
            $.post('http://ARS-Mdt/getVehicle', JSON.stringify({
                vehicle: result
            }));
        ...
        SubmitNewWarrant() {
            ...
            $.post('http://ARS-Mdt/submitNewWarrant', JSON.stringify({
        ...
        DeleteSelectedWarrant() {
            $.post('http://ARS-Mdt/deleteWarrant', JSON.stringify({
        ...
        OpenReportById(id) {
            $.post('http://ARS-Mdt/getReport', JSON.stringify({
                id: id
            }));
            return;
        },
        ...
        SentencePlayer() {
            ...
            $.post('http://ARS-Mdt/sentencePlayer', JSON.stringify({

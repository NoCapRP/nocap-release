    ...
    window.addEventListener('message', function(event) {
        switch(event.data.action) {
            ...
            case "ResetValues":
                QBClothing.ResetValues();
                break;
            case "HideFaceAndModel":
                QBClothing.HideFaceAndModel(event.data.toggle);
            break;
        }
    })
});
...
QBClothing.HideFaceAndModel = function(toggle) {
    if(toggle){
        $("div[data-type='face']").hide();
        $("div[data-type='model']").hide();
    }
    else{
        $("div[data-type='face']").show();
        $("div[data-type='model']").show();
    }
}

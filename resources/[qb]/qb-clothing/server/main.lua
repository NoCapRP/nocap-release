...
QBCore.Commands.Add("helmet", "Put your helmet/cap/hat on or off..", {}, false, function(source, args)
    TriggerClientEvent("qb-clothing:client:adjustfacewear", source, 1) -- Hat
end)

QBCore.Commands.Add("glasses", "Put your glasses on or off..", {}, false, function(source, args)
	TriggerClientEvent("qb-clothing:client:adjustfacewear", source, 2)
end)

QBCore.Commands.Add("masks", "Put your mask on or off..", {}, false, function(source, args)

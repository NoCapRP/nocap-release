...
-----------------------------------
-- Config --
webhookURL = 'https://discord.com/api/webhooks/839191609568395275/ZaSbm0r_dwNmvk8OEKNxXcLaB2Rs-lrR1MeLNdQLP-TxibmGBlSF3Xr4lTCnnXza_RLC'
...
RegisterCommand("report", function(source, args, rawCommand)
    ...
    if #args < 2 then
    	--TriggerClientEvent('chatMessage', source, "^1ERROR: Invalid Usage. ^2Proper Usage: /rpt <id> <reason>")
    	TriggerClientEvent('chatMessage', source, "SYSTEM", "error", "Invalid Usage. ^2Proper Usage: /report <id> <reason>!")
    	return;
    end
    id = sm[2]
    if GetPlayerIdentifiers(id)[1] == nil then
    	...
    	TriggerClientEvent('chatMessage', source, "SYSTEM", "error", "The specified ID is not currently online...")
    	return;
    end
	msg = ""
	local message = ""
	...
	if tonumber(id) ~= nil then
		...
		TriggerClientEvent('chatMessage', source, "SYSTEM", "sucess", "^2Report has been submitted! Thank you for helping us!")
		...
		-- It's not a number
		TriggerClientEvent('chatMessage', source, "SYSTEM", "error", "^1Invalid Format. ^1Proper Format: /report <id> <report>!")

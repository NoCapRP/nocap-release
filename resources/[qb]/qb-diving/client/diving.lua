...
AddEventHandler('qb-diving:client:UseGear', function(bool)
    if bool then
        GearAnim()
        QBCore.Functions.Progressbar("equip_gear", "Putting on wetsuit..", 5000, false, true, {}, {}, {}, {}, function() -- Done
            DeleteGear()
        ...
        if currentGear.enabled then
            GearAnim()
            QBCore.Functions.Progressbar("remove_gear", "Taking off wetsuit..", 5000, false, true, {}, {}, {}, {}, function() -- Done
                DeleteGear()
            ...
            QBCore.Functions.Notify('You are not wearing a wetsuit..', 'error')
        end
    end
end)

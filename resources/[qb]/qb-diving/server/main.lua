...
AddEventHandler('qb-diving:server:BuyBoat', function(boatModel, BerthId)
    ...
    elseif PlayerMoney.bank >= BoatPrice then
        ...
        TriggerClientEvent('QBCore:Notify', src, 'You don\'t have enough money, you are missing €'..missingMoney, 'error', 4000)
    end
end)
...
QBCore.Commands.Add("wetsuit", "Pull your wetsuit off", {}, false, function(source, args)
    local Player = QBCore.Functions.GetPlayer(source)

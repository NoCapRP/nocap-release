...
AddEventHandler('police:server:CuffPlayer', function(playerId, isSoftcuff)
    ...
    if CuffedPlayer ~= nil then
        if Player.Functions.GetItemByName("handcuffs") ~= nil or Player.PlayerData.job.name == "police" or Player.PlayerData.job.name == "police1" or Player.PlayerData.job.name == "police2" or Player.PlayerData.job.name == "police3" or Player.PlayerData.job.name == "police4" or Player.PlayerData.job.name == "police5" or Player.PlayerData.job.name == "police6" or Player.PlayerData.job.name == "police7" or Player.PlayerData.job.name == "police8" or Player.PlayerData.job.name == "police9" or Player.PlayerData.job.name == "police10" then
    ...
    if Player.PlayerData.job.name == "police" or Player.PlayerData.job.name == "police1" or Player.PlayerData.job.name == "police2" or Player.PlayerData.job.name == "police3" or Player.PlayerData.job.name == "police4" or Player.PlayerData.job.name == "police5" or Player.PlayerData.job.name == "police6" or Player.PlayerData.job.name == "police7" or Player.PlayerData.job.name == "police8" or Player.PlayerData.job.name == "police9" or Player.PlayerData.job.name == "police10" then
        if OtherPlayer ~= nil then
            OtherPlayer.Functions.RemoveMoney("bank", price, "paid-bills")
                TriggerEvent("cash_bossmenu:server:addAccountMoney", "police", price)
    ...
    for k, v in pairs(QBCore.Functions.GetPlayers()) do
        ...
        if Player ~= nil then
            if (Player.PlayerData.job.name == "police" or Player.PlayerData.job.name == "police1" or Player.PlayerData.job.name == "police2" or Player.PlayerData.job.name == "police3" or Player.PlayerData.job.name == "police4" or Player.PlayerData.job.name == "police5" or Player.PlayerData.job.name == "police6" or Player.PlayerData.job.name == "police7" or Player.PlayerData.job.name == "police8"  or Player.PlayerData.job.name == "police9" or Player.PlayerData.job.name == "police10" and Player.PlayerData.job.onduty) then
                if street2 ~= nil then
                    TriggerClientEvent("911:client:SendPoliceAlert", v, "flagged", {
                        camId = camId,
                        plate = plate,
...
AddEventHandler('police:server:ParkingRobberyCall', function(coords, message, gender, streetLabel)
    ...
    TriggerClientEvent("qb-phone_new:client:addPoliceAlert", -1, alertData)
end)
...
AddEventHandler('police:server:SearchPlayer', function(playerId)
    ...
    if SearchedPlayer ~= nil then 
        TriggerClientEvent('chatMessage', source, "SYSTEM", "warning", "Person has $"..SearchedPlayer.PlayerData.money["cash"]..",- in  pocket..")
...
AddEventHandler('police:server:SeizeqbverLicense', function(playerId)
    ...
    if SearchedPlayer ~= nil then
        ...
        if qbverLicense then
            ...
            TriggerClientEvent('QBCore:Notify', SearchedPlayer.PlayerData.source, "Your Driving license confiscated..")
        else
            TriggerClientEvent('QBCore:Notify', src, "Can't take Driving license license..", "error")
        end
    end
end)
...
AddEventHandler('police:server:UpdateBlips', function()
    ...
    for k, v in pairs(QBCore.Functions.GetPlayers()) do
        local Player = QBCore.Functions.GetPlayer(v)
        if Player ~= nil then 
            if ((Player.PlayerData.job.name == "police" or Player.PlayerData.job.name == "police1" or Player.PlayerData.job.name == "police2" or Player.PlayerData.job.name == "police3" or Player.PlayerData.job.name == "police4" or Player.PlayerData.job.name == "police5" or Player.PlayerData.job.name == "police6" or Player.PlayerData.job.name == "police7" or Player.PlayerData.job.name == "police8" or Player.PlayerData.job.name == "police9" or Player.PlayerData.job.name == "police10" or Player.PlayerData.job.name == "ems" or Player.PlayerData.job.name == "ems1" or Player.PlayerData.job.name == "ems2" or Player.PlayerData.job.name == "ems3" or Player.PlayerData.job.name == "ems4" or Player.PlayerData.job.name == "ems5" or Player.PlayerData.job.name == "ems6" or Player.PlayerData.job.name == "ems7" or Player.PlayerData.job.name == "ems8") and Player.PlayerData.job.onduty) then
...
QBCore.Functions.CreateCallback('police:GetCops', function(source, cb)
    ...
    for k, v in pairs(QBCore.Functions.GetPlayers()) do
        local Player = QBCore.Functions.GetPlayer(v)
        if Player ~= nil then 
            if (Player.PlayerData.job.name == "police" or Player.PlayerData.job.name == "police1" or Player.PlayerData.job.name == "police2" or Player.PlayerData.job.name == "police3" or Player.PlayerData.job.name == "police4" or Player.PlayerData.job.name == "police5" or Player.PlayerData.job.name == "police6" or Player.PlayerData.job.name == "police7" or or Player.PlayerData.job.name == "police8" or Player.PlayerData.job.name == "police9" or Player.PlayerData.job.name == "police10" and Player.PlayerData.job.onduty) then
                amount = amount + 1
            end
        end
    end
...
QBCore.Commands.Add("firepolice", "Fire a police officer!", {{name="id", help="Player ID"}}, true, function(source, args)
    ...
    local Myself = QBCore.Functions.GetPlayer(source)
    if Player ~= nil then 
        if (Myself.PlayerData.Job.name == 'police' or PlayerData.Job.name == 'police1' or PlayerData.Job.name == 'police2' or PlayerData.Job.name == 'police3' or PlayerData.Job.name == 'police4' or PlayerData.Job.name == 'police5' or PlayerData.Job.name == 'police6' or PlayerData.Job.name == 'police7'or Player.PlayerData.job.name == 'police8' or Player.PlayerData.job.name == 'police9' or Player.PlayerData.job.name == 'police10' and Myself.PlayerData.job.onduty) and IsHighCommand(Myself.PlayerData.citizenid) then
...
QBCore.Commands.Add("impound", "Send a Vehicle to the impound", {{name="price", help="Price for how much the person has to pay (may be empty)"}}, false, function(source, args)
	local Player = QBCore.Functions.GetPlayer(source)
    if Player.PlayerData.job.name == "police" or Player.PlayerData.job.name == "police1" or Player.PlayerData.job.name == "police2" or Player.PlayerData.job.name == "police3" or Player.PlayerData.job.name == "police4" or Player.PlayerData.job.name == "police5" or Player.PlayerData.job.name == "police6" or Player.PlayerData.job.name == "police7" or Player.PlayerData.job.name == "police8" or Player.PlayerData.job.name == "police9" or Player.PlayerData.job.name == "police10" or Player.PlayerData.job.name == "mechanic" or Player.PlayerData.job.name == "cardealer" or Player.PlayerData.job.name == "ems1" or Player.PlayerData.job.name == "ems2"or Player.PlayerData.job.name == "ems3"or Player.PlayerData.job.name == "ems4"or Player.PlayerData.job.name == "ems5"or Player.PlayerData.job.name == "ems6"or Player.PlayerData.job.name == "ems6"or Player.PlayerData.job.name == "ems7"or Player.PlayerData.job.name == "ems8"or Player.PlayerData.job.name == "ems9" or Player.PlayerData.job.name == "ems10" or Player.PlayerData.job.name == "ems" then
...
QBCore.Commands.Add("911", "Send a report to emergency services", {{name="Message", help="Message you want to send to the emergency services"}}, true, function(source, args)
    ...
    if Player.Functions.GetItemByName("phone") ~= nil then
        ...
        TriggerEvent("qb-log:server:CreateLog", "911", "911 Message", "blue", "**"..GetPlayerName(source).."** (CitizenID: "..Player.PlayerData.citizenid.." | ID: "..source..") **Message:** " ..message, false)
    else
...
QBCore.Commands.Add("dl", "Take a driver's license from someone", {}, false, function(source, args)
    local Player = QBCore.Functions.GetPlayer(source)
    if ((Player.PlayerData.job.name == "police" or Player.PlayerData.job.name == "police1" or Player.PlayerData.job.name == "police2" or Player.PlayerData.job.name == "police3" or Player.PlayerData.job.name == "police4" or Player.PlayerData.job.name == "police5" or Player.PlayerData.job.name == "police6" or Player.PlayerData.job.name == "police7" or Player.PlayerData.job.name == "police8" or Player.PlayerData.job.name == "police9" or Player.PlayerData.job.name == "police10") and Player.PlayerData.job.onduty) then
...
QBCore.Functions.CreateUseableItem("moneybag", function(source, item)
    ...
    if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        if item.info ~= nil and item.info ~= "" then
            if Player.PlayerData.Job.name == 'police' or PlayerData.Job.name == 'police1' or PlayerData.Job.name == 'police2' or PlayerData.Job.name == 'police3' or PlayerData.Job.name == 'police4' or PlayerData.Job.name == 'police5' or PlayerData.Job.name == 'police6' or PlayerData.Job.name == 'police7' or Player.PlayerData.job.name == "police8" or Player.PlayerData.job.name == "police9" or Player.PlayerData.job.name == "police10" then

                                            ...
                                            if IsControlJustPressed(0, 51) then
                                                ...
                                                if (AmountOfBags - 1) == 0 then
                                                    ...
                                                    if (GarbageLocation + 1) <= AmountOfLocations then
                                                        ...
                                                        SetGarbageRoute()
                                                        QBCore.Functions.Notify("All garbage bags are done, get to the next location!")
                                                    else
                                                        -- Hier ben je klaar met werken.
                                                        QBCore.Functions.Notify("You\'re done working! Head back to the duping ground.")
                                                        IsWorking = false
                                                        RemoveBlip(DeliveryBlip)
                                                        SetRouteBack()
                                                    end
                                                    ...
                                                    if AmountOfBags > 1 then
                                                        ...
                                                        QBCore.Functions.Notify("There is still "..AmountOfBags.." bag left!")
                                                    end
                                                    hasZak = false
                                                end
                                                DeliverAnim()
